...
suggestions = mxstorage.getItem("suggestions");
playlist = mxstorage.getItem("playlist");
videoheadline = mxstorage.getItem("videoheadline");
head = mxstorage.getItem("head");
infobar = mxstorage.getItem("infobar");
likebutton = mxstorage.getItem("likebutton");
sharebutton = mxstorage.getItem("sharebutton");
viewcount = mxstorage.getItem("viewcount");
addvideobutton = mxstorage.getItem("addvideobutton");
likebar = mxstorage.getItem("likebar");
flash = mxstorage.getItem("flash");
noflash = mxstorage.getItem("noflash");
hardflash = mxstorage.getItem("hardflash");
...
///////////
	...
	function reader() {
		...
		if (readerontext != null && readeronrange != null) {
			mxstorage.setItem('interval',readerontext.value);
		}
		...
		if (readerlargestyle != null && readerlargeimgclick != null && readerlargetitleclick != null) {
			if(readerlargestyle.style.width == '24px'){mxstorage.setItem('readerlargestyle','false');}
			else{mxstorage.setItem('readerlargestyle','true');}
		}	
		}
...
mousespotlighto = mxstorage.getItem("mousespotlighto");if(!mousespotlighto)mousespotlighto = 'true'; // default mousespotlight true
mousespotlightc = mxstorage.getItem("mousespotlightc");if(!mousespotlightc)mousespotlightc = 'false'; // default mousespotlight false
mousespotlighta = mxstorage.getItem("mousespotlighta");if(!mousespotlighta)mousespotlighta = 'false'; // default mousespotlight false
lightcolor = mxstorage.getItem("lightcolor");if(lightcolor)lightcolor = mxstorage.getItem("lightcolor");else lightcolor = '#000000'; // default color black
lightimagea = mxstorage.getItem("lightimagea");
lightimage = mxstorage.getItem("lightimage");
interval = mxstorage.getItem("interval");if(!interval)interval = 80; default_opacity = interval; // default interval 80%
fadein = mxstorage.getItem("fadein");if(!fadein)fadein = 'true'; // default fadein true
fadeout = mxstorage.getItem("fadeout");if(!fadeout)fadeout = 'true'; // default fadeout true
readera = mxstorage.getItem("readera");if(!readera)readera = 'false'; // default readera false
readerlargestyle = mxstorage.getItem("readerlargestyle");if(!readerlargestyle)readerlargestyle = 'true'; // default large style
mousespotlightt = mxstorage.getItem("mousespotlightt");if(!mousespotlightt)mousespotlightt = 'false'; // default mousespotlight false
enterpassword = mxstorage.getItem("enterpassword");
password = mxstorage.getItem("password");if(!password)password = 'false';
dynamic = mxstorage.getItem("dynamic");if(!dynamic)dynamic = 'false'; // default dynamic false
dynamic1 = mxstorage.getItem("dynamic1");
dynamic2 = mxstorage.getItem("dynamic2");
dynamic3 = mxstorage.getItem("dynamic3");
dynamic4 = mxstorage.getItem("dynamic4");
dynamic5 = mxstorage.getItem("dynamic5");
dynamic6 = mxstorage.getItem("dynamic6");
dynamic7 = mxstorage.getItem("dynamic7");
dynamic8 = mxstorage.getItem("dynamic8");
dynamic9 = mxstorage.getItem("dynamic9");
dynamic10 = mxstorage.getItem("dynamic10");
hoveroptiondyn5 = mxstorage.getItem("hoveroptiondyn5");
blur = mxstorage.getItem("blur");
cinemaontop = mxstorage.getItem("cinemaontop");if(!cinemaontop)cinemaontop = 'false'; // default cinemaontop false
spotlightradius = mxstorage.getItem("spotlightradius");if(!spotlightradius)spotlightradius = 50; // default spotlightradius 50
slideeffect = mxstorage.getItem("slideeffect");if(!slideeffect)slideeffect = 'false'; // default slideeffect false
lightimagelin = mxstorage.getItem("lightimagelin");if(!lightimagelin)lightimagelin = 'false'; // default lightimagelin false
linearsq = mxstorage.getItem("linearsq");
colora = mxstorage.getItem("colora");
intervallina = mxstorage.getItem("intervallina");
colorb = mxstorage.getItem("colorb");
intervallinb = mxstorage.getItem("intervallinb");

// Password in document
// taart make it remove or not
var i18nlockentername = "type password";//chrome.i18n.getMessage("lockentername");
var i18nlockwrongpassword = "Wrong password, try again";//chrome.i18n.getMessage("lockwrongpassword");
...
/////////// Turn Off the Lights reader slider
	...
	totlreaderbarimg1.setAttribute('src', "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA4AAAAOCAYAAAAfSC3RAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAIGNIUk0AAG4nAABzrwAA9kkAAIERAABw0QAA5xQAADJ/AAAWGO7qr+gAAAA8SURBVHjaYvz//z8DOYCJgUwwqpEWGlmQOS9evMAbqRISEoxYNZ48eRKvLf7+/nA24whIOQAAAAD//wMAkm4NYR4qfFkAAAAASUVORK5CYII=");
	totlreaderbarimg1.addEventListener('click', function (e) {toggle_small()}, true);
	totlreaderbarimg1.addEventListener("mouseover", function (e) { totlreaderbarimg1.setAttribute('src', "data:image/png;base64,"); }, false);
	totlreaderbarimg1.addEventListener("mouseout", function (e) { totlreaderbarimg1.setAttribute('src', "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA4AAAAOCAYAAAAfSC3RAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAIGNIUk0AAG4nAABzrwAA9kkAAIERAABw0QAA5xQAADJ/AAAWGO7qr+gAAAA8SURBVHjaYvz//z8DOYCJgUwwqpEWGlmQOS9evMAbqRISEoxYNZ48eRKvLf7+/nA24whIOQAAAAD//wMAkm4NYR4qfFkAAAAASUVORK5CYII="); }, false);
	...
	if (window.devicePixelRatio >= 2) { totlreaderbarimagelogo.src = "data:image/png;base64,"; }
	else { totlreaderbarimagelogo.src = "data:image/png;base64,"; }
