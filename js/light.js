...
/////////// Turn Off the Lights reader slider
	...
	totlreaderbarimg1.setAttribute('src','' + window.external.mxGetRuntime().getPrivateUrl() + 'images/minimize.png');
	totlreaderbarimg1.addEventListener('click', function (e) {toggle_small()}, true);
	totlreaderbarimg1.addEventListener("mouseover", function (e) {totlreaderbarimg1.setAttribute('src',''+window.external.mxGetRuntime().getPrivateUrl() + 'images/minimize_on.png'+'');}, false);
	totlreaderbarimg1.addEventListener("mouseout", function (e) {totlreaderbarimg1.setAttribute('src',''+window.external.mxGetRuntime().getPrivateUrl() + 'images/minimize.png'+'');}, false);
	...
	if(window.devicePixelRatio >= 2){totlreaderbarimagelogo.src = window.external.mxGetRuntime().getPrivateUrl() + 'icons/icon16@2x.png';}
	else {totlreaderbarimagelogo.src = window.external.mxGetRuntime().getPrivateUrl() + 'icons/icon16.png';}
