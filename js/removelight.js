...
fadein = mxstorage.getItem("fadein");
fadeout = mxstorage.getItem("fadeout");
readera = mxstorage.getItem("readera");
	...
	function reader() {
		...
		function saveSetting(name, value) {mxstorage.setItem('interval',value);}
